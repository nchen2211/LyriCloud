        ...
        .on("click", function(d, i) {
          ...
          */
          ...
          xmlhttp.onreadystatechange = function() {
            ...
            //   console.log(response[i].songname);
            //   // addSong(response[i].songname, response[i].freq, response[i].songID);
            // }
            localStorage.setItem("clicked_word", d.text);
            localStorage.setItem("songs_to_show",response);

            setTimeout(function(){window.location = "songList.html";}, 2000);
            
          }
          xmlhttp.open("GET", "../php/click.php?clicked_word=" + d.text, true);
          xmlhttp.send();
